  ...
  <div class="grid">
    ...
    <Dialog v-model:visible="editModal" modal :style="{ width: '400px' }">
      <div class="p-4 w">
        ...
        <div class="mb-4">
          <select v-model="editedTask.tags[0].department"
            class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            <option :value="editedTask.tags[0].department" selected>
              {{ editedTask.tags[0].department }}
            </option>
        ...
        <div class="mb-4">
          <select v-model="editedTask.tags[1].status"
            class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            <option :value="editedTask.tags[1].status" selected>
              {{ editedTask.tags[1].status }}
            </option>
            <option value="To Do" v-if="editedTask.tags[1].status !== 'To Do'">To Do</option>
            <option value="In Progress" v-if="editedTask.tags[1].status !== 'In Progress'">In Progress</option>
            <option value="Done" v-if="editedTask.tags[1].status !== 'Done'">Done</option>
          </select>
        </div>
